                ...
                <div className="p-6 grid grid-cols-1 gap-8">
                    ...
                    <div className="border-t border-gray-100 pt-6">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            {/* Global Color Picker */}
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-2">Global Default Icon Color</label>
                            ...
                            <div className="lg:col-span-2">
                                <label className="block text-sm font-medium text-gray-700 mb-2">Individual Icon Customization</label>
                                ...
                                <div className="space-y-3 max-h-[400px] overflow-y-auto pr-2 pb-2">
                                    {Object.entries(ICON_KEYS).map(([keyName, keyValue]) => (
                                        <div key={keyValue} className="flex items-center gap-4 p-3 bg-white border border-gray-200 rounded-lg shadow-sm hover:border-indigo-200 transition-colors">
                                            <span className="text-xs font-semibold text-gray-600 w-32 truncate" title={keyName}>
                                            ...
                                            <input 
                                                ...
                                                className="flex-1 text-xs border-gray-300 rounded-md shadow-sm border p-2 focus:ring-indigo-500 focus:border-indigo-500"
